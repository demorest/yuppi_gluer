...
// In fill_psrfits_struct.c
void fill_psrfits_struct(int numbits, struct psrfits *pf, float dt, char* source, int nchantot, float df, \
			 int imjd, int smjd, float offs, char* ra, char* dec, float lofreq, char* basename);
